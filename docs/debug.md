...
3. Download [vibe/samples/single.wav](https://github.com/lizehaodanniel/vibe/raw/main/samples/single.wav) and place it in the same folder (and check that the file is ok)
...
After you finished, share you results by opening [new issue](https://github.com/lizehaodanniel/vibe/issues/new?assignees=octocat&labels=bug&projects=&template=bug_report.yaml&title=[Short+title]) or just comment in the issue.
