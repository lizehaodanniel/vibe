export const aboutURL = 'https://lizehaodanniel.github.io/vibe/'
export const updateVersionURL = 'https://github.com/thewh1teagle/vibe/releases/latest'
export const modelsDocURL = 'https://lizehaodanniel.github.io/vibe/docs#models'
export const discordURL = 'https://discord.gg/EcxWSstQN8'
export const unsupportedCpuReadmeURL = 'https://lizehaodanniel.github.io/vibe/docs#install'
export const supportVibeURL = 'https://lizehaodanniel.github.io/vibe/?action=support-vibe'
export const privacyPolicyURL = 'https://lizehaodanniel.github.io/vibe/?action=open-privacy-policy'
